...
const lorraineHansbury = new Primary('Lorraine Hansbury', 54, 'Students must be picked up by a parent, guardian, or a family member over the age of 13.');
...
const subTeacher = School.pickSubstituteTeacher(['Jamal Crawford', 'Lou Williams', 'J. R. Smith', 'James Harden', 'Jason Terry', 'Manu Ginobli']);
 ...
 const yawEshun = new MiddleSchool('Yaw Eshun', 256);
 yawEshun.quickFacts();